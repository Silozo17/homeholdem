...
import { ChevronLeft, ChevronRight, Trophy, Coins, X } from 'lucide-react';
...
export function HandReplay({ open, onOpenChange, handHistory, initialHandIndex, isLandscape = false }: HandReplayProps) {
