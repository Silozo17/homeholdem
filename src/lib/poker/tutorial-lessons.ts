...
export const TUTORIAL_LESSONS: TutorialLesson[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    presetDeck: buildDeck(
      ...
      [c(7, 'hearts'), c(2, 'diamonds')],    // Viktor: 7♥ 2♦
      [c(8, 'clubs'), c(3, 'hearts')],       // Luna: 8♣ 3♥
      [c(9, 'diamonds'), c(4, 'clubs')],     // Ace: 9♦ 4♣
      [c(10, 'spades'), c(5, 'hearts'), c(12, 'diamonds')], // Flop: 10♠ 5♥ Q♦
      c(6, 'clubs'),   // Turn: 6♣
      c(11, 'spades'), // River: J♠
    ),
    botCount: 3,
    ...
    scriptedSteps: [
      ...
      // --- Human raises pre-flop ---
      { type: 'require_action', requiredAction: 'raise', message: "With A-K suited, you should raise! This tells opponents you're strong and builds the pot. Tap 'Raise' below. 👇", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'check', message: "Let's see the next card for free. Tap 'Check'. 👇", highlight: 'actions' },
      // --- Turn ---
      ...
      { type: 'require_action', requiredAction: 'check', message: "Check to see the final card. Tap 'Check'. 👇", highlight: 'actions' },
      // --- River ---
      ...
      { type: 'require_action', requiredAction: 'raise', message: "You have a monster hand! Bet to win more chips. Tap 'Raise'! 👇", highlight: 'actions' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    presetDeck: buildDeck(
      [c(14, 'hearts'), c(14, 'diamonds')],   // Human: A♥ A♦
      [c(13, 'spades'), c(13, 'clubs')],       // Viktor: K♠ K♣
      [c(8, 'hearts'), c(8, 'clubs')],         // Luna: 8♥ 8♣
      [c(5, 'spades'), c(6, 'spades')],        // Ace: 5♠ 6♠
      [c(14, 'clubs'), c(13, 'hearts'), c(8, 'diamonds')], // Flop
      c(14, 'spades'),  // Turn
      c(2, 'hearts'),   // River
    ),
    botCount: 3,
    ...
    scriptedSteps: [
      ...
      { type: 'deal_community', communityPhase: 'flop', message: "The Flop: A♣ K♥ 8♦! An Ace on the board gives you 'Three of a Kind' (also called a 'set')! Viktor has Kings and pairs his K♥ for Two Pair (K-K + A on board).", highlight: 'community', delay: 1000 },
      { type: 'coach_message', message: "Rankings recap:\n• Viktor: Two Pair (Kings + Aces)\n• You: Three of a Kind (Aces)\n\nThree of a Kind beats Two Pair! You're way ahead." },
      { type: 'require_action', requiredAction: 'raise', message: "Bet for value — we want Viktor to put more chips in! Tap 'Raise'. 👇", highlight: 'actions' },
      ...
      { type: 'deal_community', communityPhase: 'turn', message: "The Turn: A♠! Another Ace! You now have FOUR OF A KIND — the 2nd best hand in poker! Only a Straight Flush beats this. 🎰", highlight: 'community', delay: 1000 },
      { type: 'coach_message', message: "Four of a Kind = 4 cards of the same rank. You have all 4 Aces! Viktor's Kings are now crushed — his best hand is a Full House (K-K-K-A-A... wait, no — he has Two Pair K+A)." },
      { type: 'require_action', requiredAction: 'raise', message: "Bet again with your monster hand! Tap 'Raise'. 👇", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "One final value bet! Extract maximum chips. Tap 'Raise'. 👇", highlight: 'actions' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'check', message: "CHECK — pass without betting. See the next card for free. Tap 'Check'. 👇", highlight: 'actions' },
      // Turn
      ...
      { type: 'bot_action', botId: 'bot-0', botAction: { type: 'raise' }, message: "Viktor raised! He's betting 200. You'll need to CALL to stay in and chase your flush.", delay: 1500 },
      { type: 'require_action', requiredAction: 'call', message: "CALL Viktor's bet to see the final card. Your flush draw is worth chasing! Tap 'Call'. 👇", highlight: 'actions' },
      // River
      ...
      { type: 'require_action', requiredAction: 'raise', message: "RAISE with your Flush! Make Viktor pay. Tap 'Raise'. 👇", highlight: 'actions' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet to protect your top pair. In position, you control the pot size. Tap 'Raise'. 👇", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet again with your trips! Tap 'Raise'. 👇", highlight: 'actions' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'bot_action', botId: 'bot-0', botAction: { type: 'raise' }, message: "Viktor raised! He has J-high pair. But YOUR flush draw is actually a slight favourite to win by the river.", delay: 1500 },
      { type: 'require_action', requiredAction: 'call', message: "With a strong draw (9 outs), calling is correct. Tap 'Call'. 👇", highlight: 'actions' },
      // Turn
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet big with your nut flush! Tap 'Raise'. 👇", highlight: 'actions' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'bot_action', botId: 'bot-0', botAction: { type: 'raise' }, message: "Viktor raised 200! The pot is now ~500. You need to call 200.\n\n🧮 Pot Odds = 200 ÷ (500 + 200) = 29%\nYour chance = 32%\n\n32% > 29% → PROFITABLE CALL!", delay: 1500 },
      { type: 'require_action', requiredAction: 'call', message: "The math says call! Your 32% chance beats the 29% pot odds. Tap 'Call'. 👇", highlight: 'actions' },
      // Turn
      ...
      { type: 'bot_action', botId: 'bot-0', botAction: { type: 'raise' }, message: "Viktor bet again — 300 into a ~900 pot.\n\n🧮 Pot Odds = 300 ÷ (900 + 300) = 25%\nYour chance with 1 card = 17%\n\n17% < 25% → Technically unprofitable... but the payoff if you hit is huge!", delay: 1500 },
      { type: 'require_action', requiredAction: 'call', message: "Sometimes you call slightly bad odds because the 'implied odds' (extra chips you'll win) make up for it. Call! Tap 'Call'. 👇", highlight: 'actions' },
      // River
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Value bet your straight! Make Viktor pay. Tap 'Raise'. 👇", highlight: 'actions' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'bot_action', botId: 'bot-0', botAction: { type: 'raise' }, message: "Viktor raised big! He has Pocket Aces (you don't know that). Calling here with 7-2 would be throwing chips away.", delay: 1500 },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Fire a continuation bet! Act like you have a King. Tap 'Raise'. 👇", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Fire another barrel! Your story is strong. Tap 'Raise'. 👇", highlight: 'actions' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet about 50-65% of the pot. Tap 'Raise'. 👇", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Another value bet. Size it so he's tempted to call. Tap 'Raise'. 👇", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "One final value bet! Tap 'Raise'. 👇", highlight: 'actions' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Value bet your top pair. Tap 'Raise'. 👇", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Keep extracting value. Tap 'Raise'. 👇", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Final value bet! Tap 'Raise'. 👇", highlight: 'actions' },
