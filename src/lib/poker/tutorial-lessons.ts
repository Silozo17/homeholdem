...
export const TUTORIAL_LESSONS: TutorialLesson[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'raise', message: "With A-K suited, you should raise! This tells opponents you're strong and builds the pot. Tap 'Raise' to open the bet slider, set the amount to around 300, then tap 'Raise' again to confirm!", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "You have a monster hand! Bet to win more chips. Tap 'Raise', set to around 400, and confirm!" },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'raise', message: "With the best starting hand, let's raise big! Tap 'Raise', set to around 400, and confirm!", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet for value — we want Viktor to put more chips in! Tap 'Raise', set to around 300, and confirm!" },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet again with your monster hand! Tap 'Raise', set to around 500, and confirm!" },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "One final value bet! Extract maximum chips. Tap 'Raise', set to around 600, and confirm!" },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'raise', message: "RAISE with your Flush! Make Viktor pay. Tap 'Raise', pick your amount, and confirm!" },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'raise', message: "You've seen everyone act. With A-J and position info, raise to take control! Tap 'Raise', set to around 300, and confirm!", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet to protect your top pair. In position, you control the pot size. Tap 'Raise', set to around 250, and confirm!" },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet again with your trips! Tap 'Raise', set to around 400, and confirm!" },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet big with your nut flush! Tap 'Raise', set to around 500, and confirm!" },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'bot_action', botId: 'bot-1', botAction: { type: 'fold' }, message: "Luna folded.", delay: 1500 },
      { type: 'bot_action', botId: 'bot-2', botAction: { type: 'fold' }, message: "Ace folded.", delay: 1500 },
      { type: 'require_action', requiredAction: 'raise', message: "Raise pre-flop to set up your bluff! This is called 'taking the lead'. Tap 'Raise', set to around 300, and confirm!", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Fire a continuation bet! Act like you have a King. Tap 'Raise', set to around 350, and confirm!" },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Fire another barrel! Your story is strong. Tap 'Raise', set to around 500, and confirm!" },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'bot_action', botId: 'bot-2', botAction: { type: 'fold' }, message: "Ace folded.", delay: 1500 },
      { type: 'require_action', requiredAction: 'raise', message: "Raise, but not too much — you WANT callers! A raise of 2.5-3x the big blind is standard. Tap 'Raise', set to around 300, and confirm!", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Bet about 50-65% of the pot. Tap 'Raise', set to around 250, and confirm!" },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Another value bet. Size it so he's tempted to call. Tap 'Raise', set to around 400, and confirm!" },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "One final value bet! Tap 'Raise', set to around 350, and confirm!" },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    scriptedSteps: [
      ...
      { type: 'bot_action', botId: 'bot-1', botAction: { type: 'fold' }, message: "Luna folded.", delay: 1500 },
      { type: 'bot_action', botId: 'bot-2', botAction: { type: 'fold' }, message: "Ace folded.", delay: 1500 },
      { type: 'require_action', requiredAction: 'raise', message: "Strong hand, raise for value. Tap 'Raise', set to around 300, and confirm!", highlight: 'actions' },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Value bet your top pair. Tap 'Raise', set to around 300, and confirm!" },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Keep extracting value. Tap 'Raise', set to around 400, and confirm!" },
      ...
      { type: 'require_action', requiredAction: 'raise', message: "Final value bet! Tap 'Raise', set to around 500, and confirm!" },
